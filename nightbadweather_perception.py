...
# Night and Bad Weather Condition Demo for Autonomous Driving Perception System
# Demonstrating Camera, LiDAR and Radar data visualization in nighttime and adverse weather conditions
...
class DisplayManager:
    def __init__(self, grid_size, window_size):
        ...
        pygame.display.set_caption("Autonomous Driving Perception System - Night and Bad Weather Condition Demo")
...
def set_weather_to_night_and_bad(world):
    """Set weather to nighttime with adverse conditions (storm)"""
    weather = world.get_weather()
    
    # Set to night with bad weather
    weather.sun_altitude_angle = -30.0  # Night time (sun below horizon)
    weather.cloudiness = 95.0  # Very heavy cloud cover (0-100)
    weather.precipitation = 80.0  # Heavy rain (0-100)
    weather.precipitation_deposits = 90.0  # Puddles (0-100)
    weather.wind_intensity = 80.0  # Strong wind (0-100)
    weather.fog_density = 50.0  # Heavy fog (0-100)
    weather.fog_distance = 25.0  # Fog visibility distance
    weather.fog_falloff = 8.0  # How quickly fog fades
    weather.wetness = 100.0  # Road wetness (0-100)
    weather.scattering_intensity = 0.1  # Light scattering in atmosphere
    
    # Night lighting adjustments
    weather.sun_azimuth_angle = 0.0  # Sun azimuth (0-360)
    weather.mie_scattering_scale = 0.03  # Mie scattering scale
    weather.rayleigh_scattering_scale = 0.03  # Rayleigh scattering scale

    # Add moonlight by attenuating streetlights
...
def run_simulation(args, client):
    ...
    try:
        ...
        # Set to night and bad weather conditions
        set_weather_to_night_and_bad(world)
        ...
        print(f"Night and bad weather condition demo started with {len(other_vehicles)} additional vehicles. Press ESC or Q to exit.")
...
def main():
    """Main function"""
    argparser = argparse.ArgumentParser(description='CARLA Autonomous Driving Perception System - Night and Bad Weather Condition Demo')
