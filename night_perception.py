...
# Night Condition Demo for Autonomous Driving Perception System
# Demonstrating Camera, LiDAR and Radar data visualization in nighttime conditions
...
class DisplayManager:
    def __init__(self, grid_size, window_size):
        ...
        pygame.display.set_caption("Autonomous Driving Perception System - Night Condition Demo")
...
def set_weather_to_night(world):
    """Set weather to nighttime conditions"""
    ...
    weather.fog_falloff = 0.2  # Fog falloff
    
    # 增加夜间环境的星光/月光
    weather.scattering_intensity = 1.0  # 散射强度
    weather.mie_scattering_scale = 0.03  # 米氏散射
    weather.rayleigh_scattering_scale = 0.03  # 瑞利散射
...
def run_simulation(args, client):
    ...
    try:
        ...
        # Set to night conditions
        set_weather_to_night(world)
        ...
        print(f"Night condition demo started with {len(other_vehicles)} additional vehicles. Press ESC or Q to exit.")
...
def main():
    """Main function"""
    argparser = argparse.ArgumentParser(description='CARLA Autonomous Driving Perception System - Night Condition Demo')
